...
public class Estudiante extends Persona {
	...
	public String toString() {
		return "Estudiante [semestre=" + semestre + ", Semestre()=" + getSemestre() + ", Nombre()=" + getNombre()
				+ ", TipoDocumento()=" + getTipoDocumento() + ", NumeroDocumento()=" + getNumeroDocumento()
				+ ", Edad()=" + getEdad() + ", NumeroTelefonico()=" + getNumeroTelefonico()
				+ ", CorreoInstitucional()=" + getCorreoInstitucional() + ", Facultad()=" + getFacultad()
				+ ", mostrarReservas()=" + mostrarReservas() + ", Class()="
				+ getClass() + "]";
	}
